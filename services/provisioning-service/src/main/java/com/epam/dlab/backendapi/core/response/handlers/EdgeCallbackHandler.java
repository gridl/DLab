...
public class EdgeCallbackHandler<E extends EdgeInfo, T extends UploadFileResult<E>> extends ResourceCallbackHandler<T> {
	...
	@JsonCreator
	public EdgeCallbackHandler(@JacksonInject SelfServiceHelper selfServiceHelper,
		...
		super(selfServiceHelper, infrastructureCallbackHandlerService, user, uuid, action, enclosingType);

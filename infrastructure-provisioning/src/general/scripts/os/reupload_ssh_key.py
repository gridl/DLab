...
if __name__ == "__main__":
    ...
    try:
        ...
        reupload_config['notebook_name'] = os.environ['notebook_instance_name']
        ...
        reupload_config['notebook_ip'] = get_instance_private_ip_address(
            reupload_config['tag_name'], reupload_config['notebook_name'])
        reupload_config['keyfile'] = '{}{}.pem'.format(os.environ['conf_key_dir'], os.environ['conf_key_name'])
        params = '--os_user {} --notebook_ip {} --keyfile "{}"' \
            .format(reupload_config['os_user'], reupload_config['notebook_ip'], reupload_config['keyfile'])
        try:

...
if __name__ == "__main__":
    ...
    try:
        ...
        params = "--hostname {} --instance_name {} " \
                 "--keyfile {} --region {} " \
                 "--additional_config '{}' " \
                 "--os_user {} --spark_version {} " \
                 "--hadoop_version {} --edge_hostname {} " \
                 "--proxy_port {} --zeppelin_version {} " \
                 "--scala_version {} --livy_version {} " \
                 "--multiple_clusters {} --r_mirror {} " \
                 "--endpoint_url {} --exploratory_name {}" \

...
if __name__ == "__main__":
    ...
    try:
        ...
        params = "--hostname {} --keyfile {} --pip_packages 'boto3 backoff argparse fabric==1.14.0 awscli pymongo pyyaml google-api-python-client google-cloud-storage pycrypto' --user {} --region {}". \
